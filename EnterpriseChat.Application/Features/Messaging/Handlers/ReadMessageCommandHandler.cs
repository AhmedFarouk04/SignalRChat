...
public sealed class ReadMessageCommandHandler : IRequestHandler<ReadMessageCommand, Unit>
{
    ...
    private readonly IMessageRepository _messageRepo;      private readonly IRoomAuthorizationService _auth;
    ...
    public ReadMessageCommandHandler(
        ...
        IMessageRepository messageRepo,          IRoomAuthorizationService auth,
        IUnitOfWork uow,
        IMessageBroadcaster broadcaster,
        IChatRoomRepository roomRepo)
    {
        _receiptRepo = receiptRepo;
        _messageRepo = messageRepo;          _auth = auth;
        _uow = uow;
