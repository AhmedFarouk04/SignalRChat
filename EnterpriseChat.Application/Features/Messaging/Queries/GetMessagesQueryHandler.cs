    ...
    : IRequestHandler<GetMessagesQuery, IReadOnlyList<MessageReadDto>>
{
    ...
    public GetMessagesQueryHandler(IMessageReadRepository repository, IChatRoomRepository roomRepository)
    {
        _repository = repository;
        _roomRepository = roomRepository;
    }

    public async Task<IReadOnlyList<MessageReadDto>> Handle(GetMessagesQuery query, CancellationToken ct)
    {
        ...
        return await _repository.GetMessagesAsync(query.RoomId, query.Skip, query.Take, ct);
    }
}
